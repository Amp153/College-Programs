...
// Modified by Anthony Fuller to include a delete query button
   ...
   public partial class FTSForm : Form
   {
      ...
      private void DeleteSearch_Click(object sender, EventArgs e)
      {
          try 
          {
              ...
              //create a new TaggedSearchEntity to delete 
              TaggedSearchEntity deleteMe = new TaggedSearchEntity(
               groupTag, tagsListBox.Text, "*");
              deleteMe.ETag = "*";

              // create TableOperation to delete TaggedSearchEntity
              TableOperation deleteSearch = TableOperation.Delete(deleteMe);
              
              // execute the TableOperation to delete the new search
              ftsTable.Execute(deleteSearch);
          ...
          {
              MessageBox.Show(
                 String.Format("Delete Failed: Nothing is left to delete"));
          ...
          {
              MessageBox.Show(
                 String.Format("Delete Failed: {0}", exception));
          }
      }
